...
| **Latest Deploy** | https://fa7cc47c.india-gully.pages.dev |
...
## 🚀 Phase 32 — J&K Map Shape Refinement + Pin Label Fix (v35)

**Version: v35 | Build: 4.0 MB | Deploy: https://e8cf3a14.india-gully.pages.dev**  
**Commit: 85c7e8c | Date: March 2026**

### ✅ Phase 32 Deliverables

| Area | What Changed |
|------|-------------|
| **J&K Claim Polygon** | Redesigned to geographically accurate trapezoidal shape — wider body, proper POK/Gilgit-Baltistan extension on left (x=67, lon 72.5°E), Aksai Chin on right (x=187, lon 80.5°E), bottom edge (y=88) overlaps Punjab/HP for clean connection |
| **Pin Labels** | Kasauli·Chail label moved to LEFT side (text-anchor=end) to prevent overlap with Chandigarh pin; Chandigarh label stays RIGHT — no more cramped text collision in North India |
| **J&K Label** | Repositioned to centroid (127,40) of new polygon shape |

---

## 🚀 Phase 33 — Content Expansion & Map Enhancement (v36)

**Version: v36 | Build: 4.0 MB | Deploy: https://fa7cc47c.india-gully.pages.dev**  
**Commit: 5893b78 | Date: March 2026**

### ✅ Phase 33 Deliverables

| Area | What Changed |
|------|-------------|
| **5 Stub Articles Expanded** | `india-hospitality-2024` (285→850w), `entertainment-destinations-india` (305→900w), `horeca-procurement-strategy` (235→850w), `debt-special-situations-hospitality` (245→900w), `retail-leasing-malls-india` (304→850w) — all now have full institutional-grade body content |
| **Hyderabad Map Pin** | Added 7th city pin at lon 78.5°E, lat 17.4°N (cx=156, cy=323) with legend entry; HITEC City · Banjara Hills pipeline tooltip |
| **RECENT_INSIGHTS Updated** | Homepage now features 3 newest articles: HORECA Cloud Kitchen (Mar 2026), Hotel Brand Affiliation (Mar 2026), Entertainment Destination Development (Mar 2026) |
| **Article Content** | Hospitality 2024: RevPAR trends, segment dynamics, infrastructure catalysts, brand expansion; Entertainment Destinations: ₹38k Cr market, 4 format typologies with capex ranges, unit economics; HORECA Procurement: full 18-month critical path, vendor QC framework, budget control; Distressed Hotels: CIRP valuation dynamics, 5-workstream DD framework, resolution plan structuring; Mall Leasing: entertainment anchor footfall premium data, Tier 2 mall dynamics, dual-side advisory model |

---

## 🚀 Phase 32 — J&K Map Shape Refinement (v35)
...
| Area | What Changed |
|------|-------------|
| **J&K Polygon Redesign** | Replaced mushroom-shaped polygon with accurate trapezoid — left extension at x=67 (lon 72.5°E), right at x=187 (lon 80.5°E), bottom y=88 overlapping Punjab/HP states |
| **Pin Label Overlap Fix** | Kasauli·Chail label moved left (text-anchor end), Chandigarh pin lowered to cy=112, J&K label repositioned to (127,40) |
| **Improved Geography** | POK/GB area correctly extends west of x=90; Aksai Chin correctly extends east toward x=187 |

---

## 🚀 Phase 31 — J&K Map Full Territory Fix (v34)

**Version: v34 | Build: 4.0 MB | Deploy: https://3814b80f.india-gully.pages.dev**  
**Commit: bd442a8 | Date: March 2026**

### ✅ Phase 31 Deliverables

| Area | What Changed |
|------|-------------|
| **J&K Claim Polygon** | Completely redrawn using correct geographic coordinates — now covers POK, Gilgit-Baltistan, Indian-administered J&K/Ladakh AND Aksai Chin as a single unified polygon matching reference map |
| **Map Coordinates** | Polygon spans x=51.7–184.6 (lon 71.5°–80.5°E), y=0–85.5 (lat 37.5°N–32.3°N) — includes full northwest bulge into GB/POK area |
| **J&K Label** | Added subtle "J&K / India's Claim" text annotation inside claim polygon for user clarity |
| **Dashed Border** | Claim boundary uses dashed stroke (3,2) per Survey of India convention for disputed/claimed territory |

---

## 🚀 Phase 30 — Content Accuracy Sweep (v33)

**Version: v33 | Build: 4.0 MB | Deploy: https://afd4f477.india-gully.pages.dev**  
**Commit: c8ea1be | Date: March 2026**

### ✅ Phase 30 Deliverables

| Area | What Changed |
|------|-------------|
| **Services → Entertainment** | Tagline changed from "Theme parks, FECs" → "Divestments, acquisitions & entertainment real estate" |
| **Entertainment Description** | Removed "concept development, operator selection" — replaced with accurate "divestments, acquisitions, due diligence, investor advisory" |
| **Home + Listings** | Removed all "India's largest entertainment sector/real estate transaction" false claims; replaced with "landmark entertainment real estate transaction with full board and promoter alignment" |
| **Admin Chart Data** | Fixed: was showing Entertainment ₹5,700 Cr (65% concentration) — corrected to sector-accurate breakdown |
| **Testimonial T4** | Removed fake ₹2,100 Cr pipeline claim; updated to reflect actual ECL divestment advisory |
| **VERTICALS Constant** | Changed entertainment desc from "Theme parks, FECs" → "Entertainment real estate advisory" |
| **Prism Tower Card** | Fixed cover image: was `prism-myhq.jpg` (wrong building) → `prism-tower-hero.jpg` (correct) |

---

## 🚀 Phase 29 — J&K Map Fix + WhatsApp FAB Fix (v32)

**Version: v32 | Build: 4.0 MB | Deploy: https://afd4f477.india-gully.pages.dev**  
**Commit: Phase 29 | Date: March 2026**

### ✅ Phase 29 Deliverables

| Area | What Changed |
|------|-------------|
| **J&K Claim Polygon v1** | Replaced stub polygon with 24-point claim covering POK/Azad Kashmir, Gilgit-Baltistan, Aksai Chin |
| **Map Caption** | Added "J&K shown per India's claimed boundaries" note |
| **WhatsApp FAB Bug** | Fixed full-window WhatsApp SVG on Contact page — added `width:1.25rem; height:1.25rem; max-width:1.25rem` constraints |
