...
#ig-fab-main i{font-size:1.25rem;color:#fff;transition:transform .3s;width:1.25rem;height:1.25rem;max-width:1.25rem;max-height:1.25rem;overflow:hidden;}
#ig-fab-main svg{width:1.25rem!important;height:1.25rem!important;max-width:1.25rem!important;max-height:1.25rem!important;}
.ig-fab-action a svg,.ig-fab-action a i{max-width:1.1rem;max-height:1.1rem;overflow:hidden;}
...
${opts?.noNav ? '' : `<div id="ig-contact-fab" aria-label="Contact India Gully">
  ...
  <button id="ig-fab-main" aria-label="Contact options" aria-expanded="false" onclick="igFabToggle()">
    <i class="fab fa-whatsapp" style="font-size:1.25rem;width:1.25rem;height:1.25rem;display:block;"></i>
    <i class="fas fa-times" style="display:none;font-size:1.25rem;width:1.25rem;height:1.25rem;"></i>
  </button>
</div>`}
<!-- MOBILE STICKY BOTTOM BAR -->
