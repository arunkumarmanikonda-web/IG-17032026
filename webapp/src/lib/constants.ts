...
export const VERTICALS = [
  ...
  { id: 'entertainment', name: 'Entertainment', icon: '🎡', desc: 'Entertainment real estate advisory — divestments, acquisitions, due diligence and investor advisory for large-format entertainment assets.' },
...
export const LISTINGS = [
  // ── 1. Prism Tower, Gurgaon (JLL Listed) ─────────────────────────────────
  {
    ...
    images: [
      // Source: JLL Listing / prism-tower-hero — Prism Tower, Gurgaon-Faridabad Road
    ...
    coverImage: '/static/mandates/prism/prism-tower-hero.jpg',
    specs: {
      'Entity': 'Confidential (JLL Listed)',
      'Location': 'Gurgaon-Faridabad Road, Gwalpahari, Gurugram',
