...
const TESTIMONIALS = [
  ...
  {
    id: 't4',
    quote: 'India Gully advised on a complex entertainment real estate divestment process that involved multiple stakeholders, international advisors, and significant regulatory considerations. Their transaction structuring expertise and ability to coordinate all parties was the key differentiator that enabled us to reach a successful conclusion.',
    name: 'Vivek Malhotra',
    role: 'VP Projects, Entertainment Real Estate',
    sector: 'Entertainment',
    emoji: '🎡',
    location: 'Noida, NCR',
    outcome: 'Completed entertainment real estate divestment advisory',
    stars: 5,
  },
  {
    id: 't5',
